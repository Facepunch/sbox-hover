...
PS
{
    ...
    Material LerpMaterial(Material a, Material b, float amount)
    {
        ...
        o.Clearcoat =         lerp( a.Clearcoat, b.Clearcoat, amount );
        o.ClearcoatRoughness =         lerp( a.ClearcoatRoughness, b.ClearcoatRoughness, amount );
        o.ClearcoatNormal =         lerp( a.ClearcoatNormal, b.ClearcoatNormal, amount );
        ...
        o.SubsurfacePower =         lerp( a.SubsurfacePower, b.SubsurfacePower, amount );
        ...
        o.Absorption =         lerp( a.Absorption, b.Absorption, amount );
        o.IndexOfRefraction =         lerp( a.IndexOfRefraction, b.IndexOfRefraction, amount );
        o.MicroThickness =         lerp( a.MicroThickness, b.MicroThickness, amount );
